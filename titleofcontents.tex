...
{
\node[scale=1.1] at (-4,2.4){\begin{tikzpicture}
...
\draw [session1,thick] ($(b)-(2 mm,-0.06 mm)$) --++ ($(\textwidth,0.00mm)+(-72 mm,0 mm)$);
...
\hypersetup{
    colorlinks, linkcolor={magenta}, citecolor={blue}, urlcolor={magenta},
